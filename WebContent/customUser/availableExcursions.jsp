...
<div class="collapse navbar-collapse">
	<ul class="navbar-nav mr-auto">
		...
		<a class="nav-link dropdown-toggle"  id="languages" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><fmt:message key="language"></fmt:message></a>
			...
			<a class="dropdown-item" href="?sessionLocale=en&action=availableListExcursions"><fmt:message key="en" /></a>		
			<a class="dropdown-item" href="?sessionLocale=ua&action=availableListExcursions"><fmt:message key="ua" /></a>
			</div>
		</li>		
...
<table class="table table-condensed table-responsive col-sm 10">
	...
	<tbody>
		<c:forEach var="exc" items="${availableExcursions}"> 					
   			<tr>
