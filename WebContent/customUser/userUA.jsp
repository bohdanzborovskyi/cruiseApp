...
<div class="row">
	<div class="col-sm-4">
		...
		<form class="form-horizontal" method="post" action="<c:url value='/register'/>" accept-charset="UTF-8" enctype="multipart/form-data" >
			<audio controls>
				<source src="${sessionScope.mp3}" type="audio/mpeg">
			</audio>		
     			<input type="file" class="form-control" name="mp3" id="mp3" value="${sessionScope.mp3}">
     			<input type="text" hidden name="action" value="addmp3">
     			<button type="submit" class="btn btn-success"><fmt:message key="mp3" /></button>
    		</form>		
	</div>		
	<div class="col-sm-8">
		<form  class="form-horizontal" method="post" action="<c:url value='/register'/>" accept-charset="UTF-8" enctype="multipart/form-data">			
		<div class=" form-group row">	
			...
			<div class="col-sm-6">
     				<input type="text" class="form-control" name="name_ua" id="name_ua" value="${user.name}">
    			</div>	
    		</div>
    		<div class="form-group row">	    		
    			<label for="surname_ua"  class="col-sm-6 control-label"><fmt:message key="surname_ua" /></label>
			<div class="col-sm-6">
     				<input type="text" class="form-control" name="surname_ua" id="surname_ua" value="${user.surname}">
    			</div>	
    		</div>
    		<div class="form-group row">	    		
    			<label for="name_en"  class="col-sm-6 control-label"><fmt:message key="name_en" /></label>
			<div class="col-sm-6">
     				<input type="text" class="form-control" name="name_en" id="name_en" value="${requestScope.name}">
    			</div>	
    		</div>
    		<div class="form-group row">	
    			<label for="surname_en"  class="col-sm-6 control-label"><fmt:message key="surname_en" /></label>
			<div class="col-sm-6">
     				<input type="text" class="form-control" name="surname_en" id="surname_en" value="${requestScope.surname}">
    			</div>     			 
    		</div>
    		<div class="form-group row">	
