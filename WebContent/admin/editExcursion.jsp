...
<div class="collapse navbar-collapse">
	<ul class="navbar-nav mr-auto">
		...
		<a class="nav-link dropdown-toggle"  id="languages" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><fmt:message key="language"></fmt:message></a>
			...
			<a class="dropdown-item" href="adminExcursion?sessionLocale=en&action=edit&excursionID=${exc.excursionID}"><fmt:message key="en" /></a>		
			<a class="dropdown-item" href="adminExcursion?sessionLocale=ua&action=edit&excursionID=${exc.excursionID}"><fmt:message key="ua" /></a>
			</div>
		</li>			
	</ul>	
