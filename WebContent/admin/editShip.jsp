...
<div class="collapse navbar-collapse">
	<ul class="navbar-nav mr-auto">
		...
		<a class="nav-link dropdown-toggle"  id="languages" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><fmt:message key="language"></fmt:message></a>
			...
			<a class="dropdown-item" href="adminShip?sessionLocale=en&action=edit&shipID=${ship.shipID}"><fmt:message key="en" /></a>		
			<a class="dropdown-item" href="adminShip?sessionLocale=ua&action=edit&shipID=${ship.shipID}"><fmt:message key="ua" /></a>
			</div>
		</li>			
	</ul>	
...
<form method="post" action="<c:url value='/admin/adminShip'/>" accept-charset="UTF-8">
	<div class="form-group row">
		...
		<<div class="col-sm-6">
   		<input class="form-control" type="date" value="${ship.departure}" name="departure" id="departure">
 		</div>	  		    			
	</div>
